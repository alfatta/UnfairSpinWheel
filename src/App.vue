  ...
  <ScrollPanel class="h-screen">
    <div class="max-w-screen overflow-x-hidden overflow-y-hidden">
      <div class="grid header text-center">
        <h1 class="col-12 mb-0 text-4xl sm:text-5xl md:text-6xl flex align-items-center justify-content-center">
          <img src="/img/tixfly.png" class="mr-4" style="height: 4rem;" /> <span>SpinWheel</span>
        </h1>
